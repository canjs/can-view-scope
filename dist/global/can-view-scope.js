...
/*can-util@3.6.2#js/global/global*/
...
/*can-util@3.6.2#dom/document/document*/
...
/*can-util@3.6.2#js/is-browser-window/is-browser-window*/
...
/*can-util@3.6.2#js/is-plain-object/is-plain-object*/
...
/*can-util@3.6.2#dom/events/events*/
...
/*can-util@3.6.2#js/is-empty-object/is-empty-object*/
...
/*can-util@3.6.2#dom/dispatch/dispatch*/
...
/*can-util@3.6.2#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.6.2#js/is-array-like/is-array-like*/
...
/*can-util@3.6.2#js/is-iterable/is-iterable*/
...
/*can-util@3.6.2#js/cid-set/cid-set*/
...
/*can-util@3.6.2#js/make-array/make-array*/
...
/*can-util@3.6.2#js/is-container/is-container*/
...
/*can-util@3.6.2#js/is-array/is-array*/
...
/*can-util@3.6.2#js/string/string*/
...
/*can-util@3.6.2#dom/mutation-observer/document/document*/
...
/*can-util@3.6.2#dom/matches/matches*/
...
/*can-util@3.6.2#dom/events/delegate/delegate*/
...
/*can-util@3.6.2#js/single-reference/single-reference*/
...
/*can-util@3.6.2#dom/events/delegate/enter-leave*/
...
/*can-util@3.6.2#js/assign/assign*/
...
/*can-observation@3.2.0-pre.6#reader/reader*/
...
/*can-util@3.6.2#js/is-function/is-function*/
...
/*can-util@3.6.2#js/deep-assign/deep-assign*/
...
/*can-simple-map@3.1.4-pre.1#can-simple-map*/
...
/*can-view-scope@3.2.0-pre.5#reference-map*/
...
/*can-compute@3.1.0-pre.3#single-reference*/
...
/*can-compute@3.1.0-pre.3#proto-compute*/
...
/*can-compute@3.1.0-pre.3#can-compute*/
define('can-compute', function (require, exports, module) {
    ...
    var canReflect = require('can-reflect/reflections/get-set/get-set');
    var canSymbol = require('can-symbol');
    var canOnValueSymbol = canSymbol.for('can.onValue'), canOffValueSymbol = canSymbol.for('can.offValue'), canGetValue = canSymbol.for('can.getValue'), canSetValue = canSymbol.for('can.setValue'), canValueHasDependencies = canSymbol.for('can.valueHasDependencies');
    var singleReference = require('can-compute/single-reference');
...
/*can-view-scope@3.2.0-pre.5#compute_data*/
...
/*can-view-scope@3.2.0-pre.5#can-view-scope*/
